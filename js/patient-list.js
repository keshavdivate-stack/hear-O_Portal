...
const patientList = [
  { name: "Alexander White", username: "ABC-1254", mrn: "857452365", phone: "054-857 15423", account: "Enabled", status: "priority", flag: true, since: "Since: 2d | 01.08.2028", monitoring: "monitored", compliance: 92, gender: "M", careStatus: "in_progress", careTitle: "Review Carvedilol titration", careAssignee: "Amanda Lee, RN", provider: "Dr. Sarah Mitchell" },
  { name: "Dan Volex",        username: "ABC-1252", mrn: "854745856", phone: "054-857 15423", account: "Enabled", status: "priority", flag: false, since: "Since: 2d | 01.08.2028", monitoring: "monitored", compliance: 68, gender: "M", action: { type: "contacted", date: "", note: "" }, careStatus: "completed", provider: "Amanda Lee, RN" },
  { name: "Mike Brown",       username: "ABC-1251", mrn: "854125632", phone: "054-857 15423", account: "Enabled", status: "priority", flag: false, since: "Since: 2d | 01.08.2028", monitoring: "unmonitored", monSince: "Since: 1d | 01.09.2028", compliance: 34, gender: "M", provider: "Dr. James Carter" },
  { name: "Ariel Fox",        username: "ABC-1238", mrn: "854123658", phone: "054-857 15423", account: "Enabled", status: "priority", flag: false, since: "Since: 3d | 01.07.2028", monitoring: "monitored", compliance: 81, gender: "F", action: { type: "invite", date: "", note: "" }, careStatus: "recommended", careTitle: "Increase Furosemide dose", provider: "Dr. Emily Chen" },
  { name: "Jeff Frank",       username: "ABC-1242", mrn: "854123658", phone: "054-857 15423", account: "Enabled", status: "priority", flag: false, since: "Since: 4d | 01.06.2028", monitoring: "monitored", compliance: 57, gender: "M", provider: "Ayelet Er, NP" },
  { name: "Aric Snow",        username: "ABC-1283", mrn: "854125632", phone: "054-857 15423", account: "Enabled", status: "priority", flag: false, since: "Since: 8d | 01.02.2028", monitoring: "monitored", compliance: 76, gender: "M", careStatus: "in_progress", careTitle: "Review Metoprolol tolerance", careAssignee: "Ayelet Er, NP", provider: "Ayelet Er, NP" },
  { name: "Abe Lol",          username: "ABC-1222", mrn: "854125632", phone: "054-857 15423", account: "Enabled", status: "active", since: "Since: 3d | 01.07.2028", monitoring: "monitored", compliance: 88, gender: "M", careStatus: "completed", provider: "Dr. Michael Reyes" },
  { name: "Annie Zaplin",     username: "ABC-1222", mrn: "854125632", phone: "054-857 15423", account: "Enabled", status: "active", since: "Since: 3d | 01.07.2028", monitoring: "monitored", compliance: 45, gender: "F", provider: "Sandy Kohl, RN" },
  { name: "Nathan Norash",    username: "ABC-1222", mrn: "854125632", phone: "054-857 15423", account: "Paused", status: "active", since: "Since: 3d | 01.07.2028", monitoring: "monitored", compliance: 63, gender: "M", careStatus: "recommended", careTitle: "Confirm Lisinopril adherence", provider: "Dr. Sarah Mitchell" },
  { name: "Henry Fisher",     username: "ABC-1220", mrn: "965412589", phone: "054-857 15423", account: "Enabled", status: "registered", since: "Since: 3d | 01.07.2028", monitoring: "none", compliance: 12, gender: "M", provider: "Dr. James Carter" },
  { name: "Josh Ericson",     username: "ABC-1222", mrn: "854125632", phone: "054-857 15423", account: "Discontinued", status: "baseline", since: "Since: 3d | 01.07.2028", monitoring: "monitored", monInfo: true, compliance: 79, gender: "Other", careStatus: "completed", provider: "Dr. Emily Chen" },
  { name: "Jack Harris",      username: "ABC-1221", mrn: "854125698", phone: "054-857 15423", account: "Discontinued", status: "none", monitoring: "unmonitored", monSince: "Since: 5d | 01.05.2028", compliance: 24, gender: "M", provider: "Amanda Lee, RN" },
];
...
/* ---------------- Provider filter (single-select: "All Patients" or one provider) ---------------- */
const providerFilterWrap = document.querySelector('.checkbox-filter[data-name="provider"]');
const providerTrigger = providerFilterWrap.querySelector(".filter-btn");
const providerLabel = document.getElementById("providerFilterLabel");
const providerMenu = document.getElementById("providerMenu");
const ALL_PATIENTS_LABEL = "All Patients";

function renderProviderMenu() {
  providerMenu.innerHTML = `
    <div class="checkbox-filter-option provider-option ${selectedProvider === null ? "selected" : ""}" data-value="">${ALL_PATIENTS_LABEL}</div>
    ${providerOptions
      .map(
        (name) => `
      <div class="checkbox-filter-option provider-option ${selectedProvider === name ? "selected" : ""}" data-value="${name}">${name}</div>`
      )
      .join("")}
  `;
}
...
providerTrigger.addEventListener("click", (e) => {
  e.stopPropagation();
  const willOpen = !providerFilterWrap.classList.contains("open");
  closeAllFilterPopovers();
  providerFilterWrap.classList.toggle("open", willOpen);
  if (willOpen) openFilterMenu(providerFilterWrap, providerMenu);
});
...
providerMenu.addEventListener("click", (e) => {
  ...
  if (!option) return;
  selectedProvider = option.dataset.value || null;
  providerLabel.textContent = selectedProvider || ALL_PATIENTS_LABEL;
  renderProviderMenu();
  providerFilterWrap.classList.remove("open");
  closeFilterMenu(providerMenu);
  renderPatientList();
});
...
document.getElementById("clearFilters").addEventListener("click", () => {
  ...
  providerLabel.textContent = ALL_PATIENTS_LABEL;
  renderProviderMenu();
  renderPatientList();
});
