...
const ticketList = [
  ...
  { ticketId: "TCK-1207", organization: "B03", type: "Patient", who: "B03-5107", category: "System Schedule Engine", issueType: issueType("System Schedule Engine", 0), origin: "System Generated", severity: "Critical", state: "In Progress", assignedTo: "Emily Carter", created: "17.08.2028", description: "Scheduled recording run did not trigger for the patient's start date. Baseline window is at risk of expiring." },
  { ticketId: "TCK-1315", organization: "ATP", type: "Patient", who: "ATP-5215", category: "Patient (Mobile/Web)", issueType: issueType("Patient (Mobile/Web)", 0), origin: "System Generated", severity: "Critical", state: "Resolved", assignedTo: "Emily Carter", created: "12.08.2028", description: "Patient app remained paused beyond the expected threshold, blocking new recordings." },
  { ticketId: "TCK-1339", organization: "ATP", type: "Patient", who: "ATP-5239", category: "Patient (Mobile/Web)", issueType: issueType("Patient (Mobile/Web)", 1), origin: "System Generated", severity: "Critical", state: "Open", assignedTo: "Emily Carter", created: "20.08.2028", description: "Patient onboarding is stuck in baseline collection with no valid recordings for 6 days." },
  ...
  { ticketId: "TCK-1231", organization: "B03", type: "Patient", who: "B03-5131", category: "Patient (Mobile/Web)", issueType: issueType("Patient (Mobile/Web)", 0), origin: "System Generated", severity: "Critical", state: "In Progress", assignedTo: "Daniel Roy", created: "18.08.2028", description: "Patient app remained paused beyond the expected threshold, blocking new recordings." },
