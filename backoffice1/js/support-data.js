...
const clinicTickets = [
  { id: 0, ticketNo: "TCK-2018", raisedBy: "Rachel Cohen", organization: "120", issueType: "Sensors Not Uploaded", scope: "Organization", tier: "Level 3", priority: "Critical", status: "Escalated", origin: "System Generated", assignedTo: "Tomer Regev", createdDate: "02/08/2026 08:05", description: "Clinic-wide: patient devices provisioned this week are not syncing sensor data with the dashboard at all." },
  { id: 1, ticketNo: "TCK-2015", raisedBy: "David Levi", organization: "121", issueType: "Organization Compliance Drop", scope: "Organization", tier: "Level 2", priority: "Medium", status: "In Progress", origin: "System Generated", assignedTo: "Liat Peretz", createdDate: "31/07/2026 15:18", description: "Compliance chart on the clinic dashboard is showing data one day behind for the whole site." },
  { id: 2, ticketNo: "TCK-2011", raisedBy: "Miriam Katz", organization: "B01", issueType: "Signed In Not Uploaded", scope: "Organization", tier: "Level 1", priority: "Critical", status: "Open", origin: "System Generated", assignedTo: "Sarah Cohen", createdDate: "29/07/2026 12:44", description: "Several patient recordings uploaded overnight are missing from the clinic's session list." },
...
const alertRules = [
  ...
  { id: 1, name: "Recording failure", category: "Voice Engine", condition: "≥ 3 failed sessions in 24h for one patient", priority: "Medium", tier: "Level 1", slaResponse: "8h", slaResolve: "3d", channels: ["Notification"], autoCreateTicket: false, appliesTo: "All organisations" },
  ...
  { id: 3, name: "Health permission off", category: "Patient (Mobile/Web)", condition: "HealthKit / Health Connect permission revoked", priority: "Medium", tier: "Level 1", slaResponse: "8h", slaResolve: "3d", channels: ["Notification"], autoCreateTicket: false, appliesTo: "All organisations" },
  ...
  { id: 6, name: "EHR connection failure", category: "System Schedule Engine", condition: "FHIR / HL7 endpoint unreachable > 30 min", priority: "Critical", tier: "Level 3", slaResponse: "30m", slaResolve: "4h", channels: ["Notification", "Email", "SMS"], autoCreateTicket: true, appliesTo: "Per organisation" },
