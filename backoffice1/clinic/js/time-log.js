/* Time Log: reached from a Billing row (js/billing.js sets ?patient=<Patient ID>
   when navigating here). Shows per-visit time entries behind that patient's
   logged minutes -- administrative/aggregate data, no PHI beyond the Patient
   ID already shown on the Billing table. */
...
const currentPatientId = params.get("patient") || "ABC-1251";
